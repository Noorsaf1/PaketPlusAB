...
<body id="body"> 
 ...
 <section id="innerBanner"> 
  <div class="inner-content">
    <h2><span > <h1 style="color: #ffffff; font-size: 35px;">Sökresultat för nyckelord "<?php echo $_POST['searchdata'];?>"</h1></span><br>Vi tillhandahåller bilar av hög kvalitet!</h2>
    <div> 
    </div>
  </div> 
</section><!-- #Page Banner -->
      ...
      <div class="col-md-9 col-md-push-3">
        <div class="result-sorting-wrapper">
          <div class="sorting-count">
            ...
            $cnt=$query->rowCount();
            ?>
            <p><span><?php echo htmlentities($cnt);?> Listor hittades vid sökning</span></p>
          </div>
        </div>
