    ...
    if($query -> rowCount() > 0)
    {
        ...
        if(isset($_POST['submit']))
        {
            ...
            if($lastInsertId)
            {
                ...
                if($lastInsertId2)
                {
                    echo "<script>alert('Registrering lyckad. du kommer att få e-post när ditt konto har godkänts');</script>";
                }
                else
                {
...
<script type="text/javascript">
    function valid()
    {
        ...
        {
            alert("Fältet Lösenord och Bekräfta lösenord stämmer inte överens  !!");
                ...
                <div class="row flex-grow">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            ...
                            <h6 class="font-weight-light">Att registrera sig är enkelt. Det tar bara några få steg</h6>
                            <form class="pt-3" method="post" enctype="multipart/form-data" name="signup" onSubmit="return valid();">
                                ...
                                <div class="form-group mb-3">
                                    <select class="form-control form-control-lg" name="country" id="country" required>
                                        <option>Land</option>
                                        <option value="Rwanda">Sweden</option>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <label class="form-check-label text-muted">
                                            <input type="checkbox" class="form-check-input" required> Jag godkänner alla villkor
                                        </label>
                                    </div>
                                </div>
                                <div class="mt-3">
                                    <button type="submit" name="submit" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn">Registrera</button>
                                </div>
