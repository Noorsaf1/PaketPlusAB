                   ...
                   <div class="card-body">
                    ...
                    {?>
                      <div class="alert alert-success">
                        ...
                        <strong>Bra gjort!</strong> <?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
                        </div>
                      <?php } ?>
                    <br/>
                    <form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
                      ...
                      <div class="control-group">
                        <label class="control-label" for="basicinput">Namn</label>
                        <div  class="col-6">
                      ...
                      <br>
                      <div class="control-group"> 
                        <label class="control-label" for="basicinput">Aktuell bild</label>
                        <div class="controls">
                       ...
                       <div class="form-group col-md-6">
                        ...
                        <div class="input-group col-xs-12">
                          ...
                          <span class="input-group-append">
                            <button class="file-upload-browse btn btn-gradient-primary" type="button">Ladda upp</button>
                          </span>
                        </div>
                      </div>
                      <?php }} ?>
                      ...
                      <div class="form-group row">
                        <div class="col-12">
                          <button type="submit" class="btn btn-gradient-primary " name="submit">
                            <i class="fa fa-plus "></i> Uppdatering
                          </button>
                        </div>
                      </div>
                    </form>
