...
if(isset($_POST['save']))
{
  ...
  if ($LastInsertId>0) 
  {
    echo '<script>alert("Registreringen lyckades")</script>';
...
if(isset($_GET['del']))
{
  ...
  $query -> execute();
  echo "<script>alert('varumärkesrekord raderad.');</script>"; 
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
               <div class="modal-header">
                <h5 class="modal-title" style="float: left;">Märkesregister</h5>
              </div>
              <div class="col-md-12 mt-4">
                <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="row ">
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Varumärke</label>
                      <input type="text" name="brandname" class="form-control" value="" id="brandname" placeholder="Enter brand" required>
                    </div>
                  </div>
                  <button type="submit" style="float: left;" name="save" class="btn btn-primary btn-sm mr-2 mb-4">Spara</button>
                </form>
              </div>
            </div>
          </div>
              ...
              <div id="editData4" class="modal fade">
                <div class="modal-dialog modal-sm">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Redigera varumärkesinformation</h5>
                    ...
                    <div class="modal-footer ">
                      <button type="button" class="btn btn-default" data-dismiss="modal">Annullera</button>
                    </div>
                    <!-- /.modal-content -->
                  </div>
                  <!-- /.modal-dialog -->
                      ...
                      {     
                        ...
                        <tr>
                          ...
                          <td class=" text-center"><a href="#"  class=" edit_data4" id="<?php echo  ($result->id); ?>" title="click to edit"><i class="mdi mdi-pencil-box-outline" aria-hidden="true"></i></a>&nbsp;&nbsp;
                            <a href="brand.php?del=<?php echo $result->id;?>" onclick="return confirm('Vill du radera');"><i class="mdi mdi-delete"></i></i></a></td>
