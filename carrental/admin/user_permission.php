                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="modal-header">
                                    <h5 class="modal-title" style="float: left;">Användarbehörigheter</h5>
                                </div>
                                <!--  start  modal -->
                                <div id="editData" class="modal fade">
                                  <div class="modal-dialog ">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        <h5 class="modal-title">Ändra behörigheter</h5>
                    ...
                    <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                        <thead>
                            <tr>
                                ...
                                <th class="d-none d-sm-table-cell" style="width: 20%">Behörighetsnamn</th>
                                <th class="d-none d-sm-table-cell text-center" >Handling</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
