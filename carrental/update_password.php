...
{ 
  ...
  <head>
    <meta charset="utf-8">
    <title>PaketPlusAB | Uppdatera lösenord</title>
                      ...
                      <div class="profile_wrap">
                        <form name="chngpwd" method="post" onSubmit="return valid();">
                          ...
                          <div class="gray-bg field-title">
                            <h6>Uppdatera lösenord</h6>
                          </div>
                          <?php 
                          if($error)
                          {
                            ?>
                            <div class="errorWrap"><strong>FEL</strong>:<?php echo htmlentities($error); ?> </div>
                            <?php 
                          } else if($msg)
                          {
                            ?>
                            <div class="succWrap"><strong>FRAMGÅNG</strong>:<?php echo htmlentities($msg); ?> </div>
                            <?php
                          }?>
