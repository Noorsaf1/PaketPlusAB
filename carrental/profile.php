...
{ 
  ...
  <head>
    <meta charset="utf-8">
    <title>Biluthyrningsportal | Min profil</title>
  ...
  <body id="body">
    ...
    <section id="innerBanner"> 
      <div class="inner-content">
        <h2><span>Min profil</span><br>Vi skapar möjligheterna!</h2>
        <div> 
        </div>
      </div> 
    </section><!-- #Page Banner -->
                  ...
                  <div class="col-md-3 col-sm-3">
                    ...
                    <div class="col-md-6 col-sm-8">
                      <div class="profile_wrap">
                        <h5 class="uppercase underline">Allmänna Inställningar</h5>
                        <?php  
                        if($msg)
                        {
                          ?>
                        ...
                        <form  method="post">
                          <div class="form-group">
                            <label class="control-label">Reg Datum -</label>
                          ...
                          <?php if($result->UpdationDate!="")
                          {
                            ?>
                            <div class="form-group">
                              <label class="control-label">Senaste uppdatering   -</label>
                              <?php echo htmlentities($result->UpdationDate);?>
                            </div>
                            <?php 
                          } ?>
                          <div class="form-group">
                            <label class="control-label">Fullständiga namn</label>
                          ...
                          <div class="form-group">
                            <label class="control-label">Födelsedatum&nbsp;(dd/mm/yyyy)</label>
                          ...
                          <div class="form-group">
                            <label class="control-label">Din adress</label>
                          ...
                          <div class="form-group">
                            <button type="submit" name="updateprofile" class="btn btn-primary"  style="background-color: #49a3ff;"  >Spara ändringar <span class="angle_arrow"><i class="fa fa-angle-right"  style="color: #49a3ff;"  aria-hidden="true"></i></span></button>
                          </div>
                        </form>
                      </div>
                    </div>
