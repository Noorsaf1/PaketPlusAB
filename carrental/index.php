      ...
      <div class="container">
        ...
        <div class="hero-content">
          <div>
            ...
            { 
              ?>
              <a href="#loginform" data-toggle="modal" data-dismiss="modal" class="btn-banner">Logga in / Registrera dig</a> 
              <?php 
            }?>
         </div>
       </div>
      ...
      <section id="services">
        <div class="container">
          <div class="section-header">
            <h2>Hitta Din Perfekta Transportlösning</h2>
            <p>Söker du en skåpbil, lätt lastbil eller stor lastbil? Vår plattform anpassar sig efter dina transportbehov. Snabb bokning, mångsidigt urval och pålitliga fordon. Vi tar ditt företag framåt med transporttjänster du kan lita på.</p>
          </div>
                ...
                <div class="box wow  fadeInLeft">
                  <div class="car-info-box">
                    ...
                    <div class="car-title-m">
                      ...
                      <span class="price">SEK<?php echo htmlentities($result->PricePerDay);?> /TIM</span> 
                    </div>
